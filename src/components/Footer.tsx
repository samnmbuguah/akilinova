...
const socialLinks = [
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/company/akilinova/',
    icon: (
  ...
  {
    name: 'Twitter',
    url: 'https://twitter.com/akilinova',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'GitHub',
    url: 'https://github.com/akilinova',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/akilinova.ai/',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'TikTok',
    url: 'https://www.tiktok.com/@akilinova',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-red-500 to-red-700 bg-clip-text text-transparent">
              Akilinova
            </Link>
            <p className="text-gray-400 mt-2">
              Transforming security and customer experience with cutting-edge AI solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center text-gray-400 hover:text-white transition-colors duration-200">
                <a href="tel:+254705094881" className="flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  +254705094881 / +254719638128
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="space-y-2" onSubmit={handleNewsletterSubmit}>
              ...
              <button
                type="submit"
                className="w-full px-4 py-2 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:shadow-lg transition-all duration-200"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Akilinova. All rights reserved.
            </p>
